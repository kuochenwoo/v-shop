...
export function shoppingCartAdd(data: shoppingCartAddParams) {
  ...
  return request<ServiceResult<shoppingCartResult>>({
    ...
    url: `http://47.99.137.224:7072/api/product/v1/cart/add`,
    method: 'post',
    data,
  });
}
...
export function shoppingCartInfo(data?: Recordable) {
  ...
  return request<ServiceResult<shoppingCartResult>>({
    ...
    url: `http://47.99.137.224:7072/api/product/v1/cart/info`,
    method: 'get',
    params: data,
  });
}
...
export function shoppingCartRemove(data?: Recordable) {
  ...
  return request<ServiceResult<shoppingCartResult>>({
    ...
    url: `http://47.99.137.224:7072/api/product/v1/cart/delete`,
    method: 'post',
    data,
  });
}
